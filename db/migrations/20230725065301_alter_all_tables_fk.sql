...
ALTER TABLE `rooms` ADD FOREIGN KEY (`room_status_id`) REFERENCES `room_status`(id);
...
ALTER TABLE `orders` ADD FOREIGN KEY ( `room_id`) REFERENCES `rooms`(id);
ALTER TABLE `orders` ADD FOREIGN KEY ( `user_id`) REFERENCES `users`(id);
ALTER TABLE `room_guests` ADD FOREIGN KEY (`room_id`) REFERENCES `rooms`(id);
ALTER TABLE `room_guests` ADD FOREIGN KEY (`user_id`) REFERENCES `users`(id);
